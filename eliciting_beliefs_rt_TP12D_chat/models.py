...
class Constants(BaseConstants):
    name_in_url = 'eliciting_beliefs_rt_TP12D_chat'
    players_per_group = 2
...
class Group(BaseGroup):
    ...
    resent_amount = models.StringField(
        choices=['Reverse', 'Maintain'],
        widget=widgets.RadioSelect
    )
    ...
    resent_belief = models.IntegerField(verbose_name='resent belief',
                                        min=0, max=100,
                                        initial=50,
                                        widget=widgets.SliderInput())
    sent_back_amount = models.StringField(
    ...
    resent_back_amount = models.StringField(
        choices=['Do not disapply', 'Disapply'],
        widget=widgets.RadioSelect
    )

    resent_back_belief = models.IntegerField(verbose_name='resent back belief',
                                        min=0, max=100,
                                        initial=50,
                                        widget=widgets.SliderInput())